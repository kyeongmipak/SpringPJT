...
public class EventAdminListViewDto {
	// field
	int eSeqno;
	String eTitle;
	String eContent;
	...
	public EventAdminListViewDto() {
		// TODO Auto-generated constructor stub
	}

	public EventAdminListViewDto(int eSeqno, String eTitle, String eContent, String eFilename, String startDate,
			String endDate) {
		super();
		this.eSeqno = eSeqno;
		this.eTitle = eTitle;
