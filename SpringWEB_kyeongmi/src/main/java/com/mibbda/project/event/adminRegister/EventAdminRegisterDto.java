...
public class EventAdminRegisterDto {
	// field
	int eSeqno;
	String eTitle;
	String eContent;
	...
	public EventAdminRegisterDto() {
		// TODO Auto-generated constructor stub
	}

	public EventAdminRegisterDto(int eSeqno, String eTitle, String eContent, String eFilename, String startDate,
			String endDate) {
		super();
		this.eSeqno = eSeqno;
		this.eTitle = eTitle;
