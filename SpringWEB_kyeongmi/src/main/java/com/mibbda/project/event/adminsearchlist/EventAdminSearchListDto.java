...
public class EventAdminSearchListDto {
	...
	public EventAdminSearchListDto() {
		// TODO Auto-generated constructor stub
	}

	public EventAdminSearchListDto(int eSeqno, String eTitle, String eContent, String eFilename, String startDate,
			String endDate) {
		super();
		this.eSeqno = eSeqno;
		this.eTitle = eTitle;
